...
from cakes.views import create_cake, list_cakes,list_birthday,create_birthday,list_alfajores,create_alfajores,birthday_update
...
urlpatterns=[
    ...
    path('update-birthday/<int:id>', birthday_update),
